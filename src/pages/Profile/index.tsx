                        ...
                        <View className="px-5 py-3">
                            ...
                            <View className="mt-1 flex-row items-start justify-between">
                                <View className="flex-row items-center">
                                    <View
                                        className={`absolute left-0 top-[6] h-4 w-4 rounded-full ${statusColor(
                                            data?.status,
                                        )}`}
                                    />
                                    <Text className="ml-5 max-w-[250] text-xl text-white">
                                        {data?.statusDescription ? data?.statusDescription : data?.status}
                                    </Text>
                                </View>
                                <View
                                    style={{ backgroundColor: getRankColorByTags(data?.tags) }}
                                    className="mt-[2] flex-row items-center justify-center rounded-lg px-2 py-1"
                                >
